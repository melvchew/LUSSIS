<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createuser.aspx.cs" Inherits="LUSSIS.View.createuser" %>
                        ...
                        <ContentTemplate>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="ddlEmpId" runat="server">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList  ID="ddlRole" runat="server">
                                            <asp:ListItem>StoreClerk
                                            </asp:ListItem>
                                            <asp:ListItem>StoreSupervisor
                                            </asp:ListItem>
                                            <asp:ListItem>StoreManager
                                            </asp:ListItem>
                                            <asp:ListItem>DeptEmp
                                            </asp:ListItem>
                                            <asp:ListItem>DeptRep
                                            </asp:ListItem>
                                            <asp:ListItem>DeptHead
                                            </asp:ListItem>
                                            <asp:ListItem>DeptActingHead
