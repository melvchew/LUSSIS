                ...
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtBin" ErrorMessage="Bin Number is Required" ForeColor="Red"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-sm-2">
                            <p>Category</p>
                        </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            <asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="txtReorderLevel" ErrorMessage="Reorder Level must be Numeric" MaximumValue="99999" MinimumValue="0" ForeColor="Red"></asp:RangeValidator>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtReorderLevel" ErrorMessage="Reorder level is required" ForeColor="Red"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-10">
                            ...
                            <asp:RangeValidator ID="RangeValidator3" runat="server" ControlToValidate="txtReorderQty" ErrorMessage="Reorder Qty must be Numeric" MaximumValue="99999" MinimumValue="0" ForeColor="Red"></asp:RangeValidator>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtReorderQty" ErrorMessage="Reorder Qty is required" ForeColor="Red"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-sm-2">
                            <p>Unit of Measure</p>
                        </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            <asp:RangeValidator ID="RangeValidator4" runat="server" ControlToValidate="txtSupplier1Price" ErrorMessage="Supplier Price must be Numberic" MaximumValue="99999.99" MinimumValue="0.00" ForeColor="Red"></asp:RangeValidator>
                        </div>
                        <div class="col-sm-2">
                            <p>Supplier#2</p>
                        </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            <asp:RangeValidator ID="RangeValidator5" CssClass="form-control" runat="server" ControlToValidate="txtSupplier2Price" ErrorMessage="Supplier Price must be Numberic" MaximumValue="99999.99" MinimumValue="0.00" ForeColor="Red"></asp:RangeValidator>
                        </div>
                        <div class="col-sm-2">
                            <p>Supplier#3</p>
                        </div>
