                ...
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="*Company Name can't be null" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="*SupplierID must be captial letter" ControlToValidate="TextBox1" ForeColor="Red" ValidationExpression="^[A-Z]+$"></asp:RegularExpressionValidator>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-8" style="margin-top: 27px;">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox4" ErrorMessage="*Phone No can't be null" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="*input number or space character" ForeColor="Red" ControlToValidate="TextBox4" ValidationExpression="^[ 0-9]*$"></asp:RegularExpressionValidator>
                        </div>
                        <div class="col-sm-4 ">
                        ...
                        <div class="col-sm-8">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="*input number or space character" ForeColor="Red" ControlToValidate="TextBox5" ValidationExpression="^[ 0-9]*$"></asp:RegularExpressionValidator>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-8">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBox6" ErrorMessage="*Address can't be null" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-8">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TextBox7" ErrorMessage="*Email can't be null" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
