<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateProduct.aspx.cs" Inherits="AD_Web.UpdateProduct" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
        <div class="row">
            <div class="col-sm-12" style="text-align:center"><h2>Update Product</h2>        <asp:TextBox ID="txtID" runat="server" Visible="False"></asp:TextBox></div>
            <div class="col-sm-7">
                <div class="row">
                    <div class="col-sm-4">
                        <p>Bin#</p>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtBin" ErrorMessage="Bin Number is Required"></asp:RequiredFieldValidator>
                    ...
                    <div class="col-sm-12" style="text-align: right"> <asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" Text="UPDATE" OnClick="Button1_Click" /></div>
                </div>
            </div>
